...
// //   /* ----- Person API Methods ---------------------------------------------------------------- */
// listPersons({ criteria, options }): Person[] {
//   const persons = this.v3.searchPersons(criteria, options)
//   return persons.objects
// },

// listPersonsWithCriteria({ criteria }): Person[] {
//   return this.listPersons({ criteria, options: this.v3.fetchPersonCompletely() })
// },

// listPersonsWithToken(): Person[] {
//   return this.listPersons({ criteria: new this.v3.PersonSearchCriteria(), options: this.v3.fetchPersonCompletely() })
// },

// async listPersonsOfSpace(spaceCode: string): Promise<Person[]> {
...
// async listPersonsOfProject(project: Project): Promise<Person[]> {
...
//   )
//   return results.objects.map(ra => ra.user)
// },
